<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PublicHeader.ascx.cs" Inherits="Account_UserControls_PublicHeader" %>
				...
				<div class="navbar-right">
						<div class="collapse navbar-collapse" id="myNavbar">
							<ul class="nav navbar-nav navbar-right navigationLinks">
										...
										<LoggedInTemplate>
											<li><a href="/Account/Profile.aspx" class="dropdown-toggle" data-toggle="dropdown"><asp:Literal ID="lblFullName" runat="server"></asp:Literal> <span class="caret"></a>
												<ul class="dropdown-menu">
													...
													<li runat="server" id="liRebuildAdmin" visible="false"><a href="/Account/Organization/Default.aspx">Disasater Dashboard</a></li>
								...
								<li><asp:LoginStatus ID="loginStatusLogin" runat="server" LogoutText="" LoginText="LOG IN" /></li>
							</ul>
						</div>
				</div>
			</nav>
