<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="BasicNeedsSurveyEdit.aspx.cs" Inherits="CrowdRelief.BasicNeedsSurveyFormEdit" %>
				...
				<div class="container help-1" id="divFormFields" runat="server">
					<div class="row">
						...
						<div class="col-xs-10 col-sm-8"> 
							...
							<!-- Form Name -->
							<legend><h1>Edit Request</h1></legend>
								<br /><br />

							<!-- Text input-->
							<div class="form-group">
							  <label class="col-md-8 control-label bg-4"><h1>INFORMATION ABOUT PERSON NEEDING HELP</h1></label> 
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							  <label class="col-md-8 control-label bg-4"><h1>LOSS INFORMATION</h1></label> 
							</div>
							...
							<div class="form-group">
							  <label class="col-md-8 control-label bg-4"><h1>BASIC NEEDS</h1></label> 
							</div>
							...
							<!-- Multiple Radios (inline) -->
							<div class="form-group">
							  <label class="col-md-4 control-label" for="radioClothingNeed">Is clothing needed?</label>
							  <div class="col-md-4">
							...
							<div class="form-group">
							  <label class="col-md-5 control-label" for="txtSingleBeds">NUMBER OF BEDS NEEDED</label> 
							</div>
							...
							<!-- Multiple Checkboxes -->
							<div class="form-group">
							  <label class="col-md-4 control-label" for="chkBoxLivingRoom">Living/Dining/Bed Room Furnishings</label>
							  <div class="col-md-4">
							...
							<div class="form-group">
								<div class="col-md-4">
									<label class="control-label" for="chkBoxLivingRoom"><h2>Write a Compelling Flood Story</h2>Mininum of 3 paragraphs REQUIRED.<br />This story will become the driving force behind the campaign. Please write a compelling story that will make people want to give to this person.</label>
								</div>
								<div class="col-md-8">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-4">
								<asp:Button	 id="btnSubmit" runat="server" name="btnSubmit" OnClick="btnSubmit_Click" Text="Update This Survey" class="btn btn-primary"></asp:Button>
							  </div>
							</div>
					...
					<div class="row">
						...
						<div class="col-xs-10 col-sm-4">
							...
							<div style="margin-top:20px;">
								<asp:HyperLink ID="hypGoToSurvey" runat="server" Text="Go To ThiS Survey"></asp:HyperLink>
							</div>
						</div>
						<div class="col-xs-1 col-sm-4"></div>
					</div>
