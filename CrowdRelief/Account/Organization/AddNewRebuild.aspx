<%@ Page Title="" Language="C#" MasterPageFile="~/Account/MasterPages/SecureOrganization.master" AutoEventWireup="true" CodeFile="AddNewRebuild.aspx.cs" Inherits="Account_Organization_AddNewRebuild" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContentPlaceHolder" Runat="Server">
    <link rel="stylesheet" href="/Scripts/vendor/bootstrap-datepicker-master/dist/css/bootstrap-datepicker3.min.css" />
    <link rel="stylesheet" href="/Scripts/vendor/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" />
    <link rel="stylesheet" href="/Scripts/vendor/select2-3.5.2/select2.css" />
    <link rel="stylesheet" href="/Scripts/vendor/select2-bootstrap/select2-bootstrap.css" />
	<script src="/Scripts/vendor/bootstrap-datepicker-master/dist/js/bootstrap-datepicker.min.js"></script>
	<script src="/Scripts/vendor/select2-3.5.2/select2.min.js"></script>
				...
				<div class="panel-body">
					...
					<div id="hbreadcrumb" class="pull-right m-t-lg">
						<ol class="hbreadcrumb breadcrumb">
							<li class="active"><span>New Rebuild Project</span></li>
						</ol>
					</div>
								...
								<div class="panel-body">
									...
									<div class="form-group ">
										<div class="input-group">
											...
											Use support@crowdrelief.net if no email.
									</div>
								</div>
							</div>
							<div class="hpanel">
										...
										<div class="col-xs-4">
											<div class="m-b-lg border-bottom">
												...
												<div id="divTaskTypedropdown" class="dropdown m-b-md" runat="server">
													...
													<button id="btn-dropdown" class="btn btn-outline btn-default dropdown-toggle dropdown-volunteer" type="button" data-toggle="dropdown">Choose Difficulty <div id="base"></div></button>
