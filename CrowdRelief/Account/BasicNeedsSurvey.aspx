<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BasicNeedsSurvey.aspx.cs" Inherits="CrowdRelief.BasicNeedsSurveyForm" %>
				...
				<div class="container help-1" id="divFormFields" runat="server">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8">
							...
							<small>
								<b>CrowdRelief Basic Needs Survey</b> captures only the basic household needs of a person in distress.
								<br /><br />
								...
								<br /><br />
								By posting this information you agree to allow CrowdRelief to share personal and non-personal information with citizens and other organizations who are willing to help you meet these needs.
								...
								<br /><br />
								<a href="/About.aspx" target="_blank">Learn more about how CrowdRelief works here.</a>
							</small>
								<br /><br />
				...
				<div class="container-fluid bg-3 text-center">  
					<div class="row">
						...
						<div class="col-xs-10 col-sm-4">
							<br />
							Please email your homes flood photos to<br /> <a href="mailto:Support@CrowdRelief.net">Support@CrowdRelief.net</a><br /> and reference this ticket number all emails.
							<br />
							...
							<div style="margin-top:20px;">
								<button type="button" class="btn btn-danger btn-lg btn-block btn-1" runat="server" id="btnHelpNavigation">Request Help</button>
							</div>
						</div>
						<div class="col-xs-1 col-sm-4"></div>
					</div>
