<%@ Page Title="" Language="C#" MasterPageFile="~/Account/MasterPages/SecureUser.master" AutoEventWireup="true" CodeFile="ProgressUpdates.aspx.cs" Inherits="Account_RecoveryDashboard_ProgressUpdates" %>
...
<asp:Content ID="Content1" ContentPlaceholderID="HeadContentPlaceHolder" Runat="Server">
	...
	<script type="text/javascript">
		$(document).ready(function ()
		{
			...
			function updateRebuildProgressSlider(tickValue, sliderId, userId) {
				...
				$.ajax(
				{
					...
					data: "tickValue=" + tickValue + "&sliderId=" + sliderId + "&userId=" + userId,
        ...
        <div class="hpanel">
            ...
            <div class="panel-body">
				...
				<div class="m-t-lg pull-right">
					<a href="Default.aspx" class="btn w-xs btn-info">Update Complete</a> </small>
				</div>
			</div>
		</div>
</div>
