<%@ Page Title="" Language="C#" MasterPageFile="~/Account/MasterPages/SecureUser.master" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="Account_RecoveryDashboard_Profile" %>
		...
		<div class="col-lg-4">
			<div class="hpanel hgreen">
				<div class="panel-body">
					...
					<img alt="logo" class="img-circle m-b m-t-md" src="/images/etta.png">
					<h3><a href="">Etta Daughdrill</a></h3>
					<div class="text-muted font-bold m-b-xs">Maurepaus, La</div>
					<p>
		...
		<div class="col-lg-8">
			<div class="hpanel">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#tab-1">Project</a></li>
